    ...
    return e.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (t, n) {
        ...
        function (Y, Z) {
            ...
            if (!J(_("html"), a)) {
                ...
                so(), e.fp_easings = Q(e.fp_easings, {
                ...
                }, e.fullpage_api = ve, jt("continuousHorizontal"), jt("scrollHorizontally"), jt("resetSliders"), jt("interlockedSlides"), jt("responsiveSlides"), jt("fadingEffect"), jt("dragAndMove"), jt("offsetSections"), jt("scrollOverflowReset"), jt("parallax"), oo("dragAndMove") && ve.dragAndMove.init(), Z.css3 && (Z.css3 = function () {
                    ...
                    for (var e = _(h), r = 0; r < e.length; r++) {
                        ...
                        }), void 0 !== Z.anchors[S] && m.setAttribute("data-anchor", Z.anchors[S]), d = s, v = i, void 0 !== Z.anchors[v] && J(d, c) && jn(Z.anchors[v], v), Z.menu && Z.css3 && null != ge(_(Z.menu)[0], o) && ce.appendChild(_(Z.menu)[0]), f > 0 ? Pt(s, u, f) : Z.verticalCentered && Dn(s)
                    }
                    var d, v, m, S;
            ...
            function xt(e, t) {
                void 0 !== t ? (t = t.replace(/ /g, "").split(",")).forEach(function (t) {
                    to(e, t, "m")
                }) : to(e, "all", "m"), Le(Pe, "setAllowScrolling", {
                    value: e,
                    directions: t
                })
            }
            ...
            function Lt(e) {
                e ? (Et(!0), (Ne || je) && (Z.autoScrolling && (ce.removeEventListener(tt.touchmove, Gt, {
                    passive: !1
                }), ce.addEventListener(tt.touchmove, Gt, {
                    passive: !1
                })), _(o)[0].removeEventListener(tt.touchstart, _t), _(o)[0].removeEventListener(tt.touchmove, Ft, {
                    passive: !1
                }), _(o)[0].addEventListener(tt.touchstart, _t), _(o)[0].addEventListener(tt.touchmove, Ft, {
                    passive: !1
                }))) : (Et(!1), (Ne || je) && (Z.autoScrolling && (ce.removeEventListener(tt.touchmove, Ft, {
                    passive: !1
                }), ce.removeEventListener(tt.touchmove, Gt, {
                    passive: !1
                })), _(o)[0].removeEventListener(tt.touchstart, _t), _(o)[0].removeEventListener(tt.touchmove, Ft, {
                    passive: !1
                })))
            ...
            function Pt(e, n, o) {
                ...
                u.className = R, pe(n, u), q(_(I, e), {
                    width: r + "%"
                }), o > 1 && (Z.controlArrows && (a = e, s = [Te('<div class="' + V + '"></div>'), Te('<div class="' + G + '"></div>')], me(_(H, a)[0], s), "#fff" !== Z.controlArrowColor && (q(_(F, a), {
                        ...
                        ro("parallax", "apply", l), Z.autoScrolling && Z.continuousVertical && void 0 !== l.isMovementUp && (!l.isMovementUp && "up" == l.yMovement || l.isMovementUp && "down" == l.yMovement) && ((u = l).isMovementUp ? Se(_(g)[0], Ce(u.activeSection, h)) : me(_(g)[0], He(u.activeSection, h).reverse()), $n(_(g)[0].offsetTop), qt(), u.wrapAroundElements = u.activeSection, u.dtop = u.element.offsetTop, u.yMovement = Pn(u.element), u.leavingSection = ie(u.activeSection, h) + 1, u.sectionIndex = ie(u.element, h), Le(_(o)[0], "onContinuousVertical", u), l = u), oo("scrollOverflowReset") && ve.scrollOverflowReset.setPrevious(l.activeSection), l.localIsResizing || fn(l.activeSection), Z.scrollOverflow && Z.scrollOverflowHandler.beforeLeave(), ue(e, c), fe(ye(e), c), sn(e), Z.scrollOverflow && Z.scrollOverflowHandler.onLeave(), Ve = ve.test.isTesting, Fn(i, r, l.anchorLink, l.sectionIndex),
                            function (e) {
                                if (Z.css3 && Z.autoScrolling && !Z.scrollBar) {
                                    ...
                                    Vn(t, !0), Z.scrollingSpeed ? (clearTimeout(Ue), Ue = setTimeout(function () {
                                        ln(e)
            ...
            function tn(e, t) {
                var n, o, r, i, l = (o = e, r = t, (i = Z.v2compatible ? {
                    ...
                    afterRender: function () {
                        return {
                            section: nn(_(g)[0]),
                            slide: on(_(k, _(g)[0])[0])
                        }
                    },
                    onLeave: function () {
                        return {
                            origin: nn(r.activeSection),
                            destination: nn(r.element),
            ...
            function mn(n) {
                at = t.createElement("div"), lt = vn("MTIzPGRpdj48YSBocmVmPSJodHRwOi8vYWx2YXJvdHJpZ28uY29tL2Z1bGxQYWdlL2V4dGVuc2lvbnMvIiBzdHlsZT0iY29sb3I6ICNmZmYgIWltcG9ydGFudDsgdGV4dC1kZWNvcmF0aW9uOm5vbmUgIWltcG9ydGFudDsiPlVubGljZW5zZWQgZnVsbFBhZ2UuanMgRXh0ZW5zaW9uPC9hPjwvZGl2PjEyMw=="), at.innerHTML = lt, at = at.firstChild, "MutationObserver" in e && new MutationObserver(hn).observe(t.body, {
                    childList: !0,
                    subtree: !1
                }), oo(n) && ve[n] && (pn(n) || (Sn(), setInterval(Sn, 2e3)))
            }
            ...
            function En(e) {
                ...
                9 === o ? function (e) {
                    ...
                    }(n = e, o = Mn(t), r = o.indexOf(t.activeElement), i = n.shiftKey ? r - 1 : r + 1, l = o[i], a = on(ge(l, O)), s = nn(ge(l, h)), a || s) && (u ? null == ge(u, g + "," + g + " " + k) && (u = d(e)) : d(e), (!c && u == f[f.length - 1] || c && u == f[0]) && Ee(e))
